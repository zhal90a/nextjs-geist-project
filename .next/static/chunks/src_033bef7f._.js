...
const TendikDetail = ({ params })=>{
    ...
    const [tendikData, setTendikData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        foto: "https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/73287092-8904-45ca-8a3a-9bc4f75dff74.png",
        nama: "Sari Indrawati, S.Kom.",
        nip: params.nip,
        email: "sari.indrawati@fh.univ.ac.id",
        ...
        deskripsi: "Sari Indrawati adalah Kepala Tata Usaha Fakultas Hukum dengan pengalaman lebih dari 12 tahun dalam bidang administrasi akademik dan manajemen perkantoran. Beliau bertanggung jawab dalam koordinasi kegiatan administratif fakultas.",
        jabatan: "Kepala Tata Usaha",
        unitKerja: "Fakultas Hukum",
        golongan: "III/c",
        ...
        tugasPokok: [
            ...
            "Supervisi staff administrasi",
            "Pelaporan kegiatan fakultas"
        ],
        pengalaman: [
            {
                tahun: "2020-Sekarang",
                posisi: "Kepala Tata Usaha",
                unit: "Fakultas Hukum"
            },
            {
                tahun: "2015-2020",
                posisi: "Staff Administrasi Senior",
                unit: "Fakultas Hukum"
            },
            {
                tahun: "2012-2015",
        ...
        pelatihan: [
            {
                tahun: "2023",
                nama: "Pelatihan Manajemen Perkantoran Modern",
                penyelenggara: "Kemendikbud"
            },
            {
                tahun: "2022",
                nama: "Workshop Sistem Informasi Akademik",
    ...
    const handleFormSubmit = async (type, data)=>{
        ...
        try {
            ...
            setTendikData((prev)=>{
                ...
                if (type === 'tugas') {
                    if (editingItem) {
                        updated.tugasPokok[editingItem.index] = data.tugas;
                    } else {
                        updated.tugasPokok.push(data.tugas);
                    }
                } else if (type === 'pengalaman') {
                    if (editingItem) {
                        updated.pengalaman[editingItem.index] = data;
                    } else {
                        updated.pengalaman.push(data);
                    }
                } else if (type === 'pelatihan') {
                    if (editingItem) {
                        updated.pelatihan[editingItem.index] = data;
                    } else {
                        updated.pelatihan.push(data);
                    }
                }
                return updated;
            });
...
_s(TendikDetail, "OQAr4anor5XugtVO+3GOpe4YRDY=");
_c = TendikDetail;
...
//# sourceMappingURL=src_033bef7f._.js.map